export type SkillIcon =
  | { type: "fab" | "fas"; class: string; color?: string }
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        icon: {
          type: "img",
          src: "https://xgboost.readthedocs.io/en/stable/_static/xgboost_logo.png",
          alt: "XGBoost",
        },
      },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Power BI",
        icon: { type: "fab", class: "fa-microsoft", color: "#F2C811" },
      },
      {
        name: "Pandas",
        icon: {
      ...
      },
      {
        ...
        icon: {
          type: "img",
          src: "https://geopandas.org/en/stable/_static/geopandas_logo.png",
          alt: "GeoPandas",
        },
      },
      {
